...
const State = z.object({enabled:z.boolean(),radiusKm:z.number().positive().max(250).default(100),intervalSeconds:z.number().int().min(30).max(3600).default(60),maxNotificationsPerRun:z.number().int().min(0).max(50).default(10)});
